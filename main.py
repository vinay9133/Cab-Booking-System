...
def feedpage():
    ...
    ebutton=Button(canvas,text="Give Review",width=15,fg="white",bg="Red",font=("Arial",13,'bold'),command=submitreview)
    canvas.create_window(850,650,window=ebutton)
    canvas.create_text(683,100,text="Feedback" ,fill="White",font=("Arial",25,'underline'))
    canvas.create_text(400,300,text="Rating" ,fill="red",font=("Arial",13))
    canvas.create_text(400,450,text="Review" ,fill="red",font=("Arial",13))
    var = StringVar(root)
    var.set(1)
    secmenu=  ttk.Combobox(root, width=30,height=20,textvariable=var)
    secmenu['values'] =list(range(1,6))
    secmenu['state'] = 'readonly'
    feedEntry=Text(canvas, height=10, width=65,fg='White',bg="red",bd=4,font=("Arial",10,'italic'))
...
def cabbook():
    ...
    canvas.create_rectangle(0,0,1366,200,fill="#513B1C",outline="navy blue")
    canvas.create_rectangle(590,200,890,500,fill="white")
    canvas.create_text(20,30,text="VCabs",fill='white',font=("bauhaus 93",25),anchor=NW)
    ...
    bookbutton=Button(canvas,text="book Ride",width=10,fg="white",bg="#000000",font=("Arial",13,'bold'),command=book)
    canvas.create_window(750,450,window=bookbutton)
    canvas.create_text(1150,50,text="Welcome "+loggedname,font=("Arial",15),fill="white")
    canvas.pack()
    detbutton=Button(canvas,text="View Past booking",width=15,fg="black",bg="#FFEF00",bd=0,font=("Arial",13,'bold'),command=viewbooking)
    canvas.create_window(1150,90,window=detbutton)
    lobutton=Button(canvas,text="Logout",width=15,fg="black",bg="#FFEF00",bd=0,font=("Arial",13,'bold'),command=loginpage)
    canvas.create_window(1150,180,window=lobutton)
    cpbutton=Button(canvas,text="Change your Password",width=20,fg="black",bg="#FFEF00",bd=0,font=("Arial",13,'bold'),command=changepasswordpage)
    canvas.create_window(1150,120,window=cpbutton)
    revbutton=Button(canvas,text="Review",width=20,fg="black",bg="#FFEF00",bd=0,font=("Arial",13,'bold'),command=feedpage)
    canvas.create_window(1150,150,window=revbutton)
    root.mainloop()
def cadminlogin():
    global userEntered
    global passEntered
...
def loginpage():
    ...
    backgroundIMG=PhotoImage(file="background.gif")
    canvas.create_image(0,0,image=backgroundIMG,anchor=NW)
    canvas.create_rectangle(90,150,430,550,fill="#033E3E",outline="white")
    ...
    canvas.create_window(300,300,window=userEntered)
    canvas.create_window(300,350,window=passEntered)
    Loginbutton=Button(canvas,text="Login",width=10,fg="white",bg="#565051",font=("Arial",13,'bold'),command=validate)
    canvas.create_window(200,450,window=Loginbutton)
    Regbutton=Button(canvas,text="Register",fg="white",bg="#033E3E",bd=0,font=("Arial",13,'bold'),command=RegisterPage)
    canvas.create_window(320,450,window=Regbutton)
    forgbutton=Button(canvas,text="Forgot Password",fg="white",bg="#033E3E",bd=0,font=("Arial",10,'underline'),command=forgotpage)
    canvas.create_window(280,380,window=forgbutton)
    abutton=Button(canvas,text="Admin Login",fg="white",bg="#033E3E",bd=0,font=("Arial",10,'underline'),command=adminloginpage)
